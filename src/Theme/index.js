...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#fd9537' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#fd9537',
  primary2: darkMode ? '#3680E7' : '#cc884b',
  primary3: darkMode ? '#4D8FEA' : '#cc884b',
  primary4: darkMode ? '#376bad70' : '#F6DDE8',
  primary5: darkMode ? '#153d6f70' : '#FDEAF1',

  // color text
  primaryText1: darkMode ? '#6da8ff' : '#fd9537',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#fd9537',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #fd953730 0%, #fff 0%)`,
})
